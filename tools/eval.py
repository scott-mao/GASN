...
from toolkit.datasets import OTBDataset, UAVDataset, LaSOTDataset, SARDataset,\
...
def main():
   ...
   #
        ...
        benchmark.show_result(success_ret, precision_ret,
                show_video_level=args.show_video_level)
    elif args.dataset in ['VOT2016', 'VOT2017', 'VOT2018', 'VOT2019','SAR']:
        dataset = SARDataset(args.dataset, root)
        dataset.set_tracker(tracker_dir, trackers)
